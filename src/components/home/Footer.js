...
function Footer() {
  return (
    <div className='container mx-auto text-center bg-base-white'>
      <div class="mb-16">
        <footer class="text-gray-600 body-font bg-gray-700">
          <div class="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col">
            <div class="w-64 flex-shrink-0 md:mx-0 mx-auto text-center md:text-left">
              ...
              <p class="mt-2 ml-2 text-sm text-white">Lorem ipsum dolor sit amet consectetur.</p>
            </div>
          ...
          <div class="bg-gray-900">
            <div class="container mx-auto py-4 px-5 flex flex-wrap flex-col sm:flex-row">
              <p class="text-white text-sm text-center sm:text-left">© 2022 lorem ipsum—
                <a href="https://twitter.com/knyttneve" rel="noopener noreferrer" class="text-gray-400 ml-1" target="_blank">Tüm hakları saklıdır</a>
              </p>
